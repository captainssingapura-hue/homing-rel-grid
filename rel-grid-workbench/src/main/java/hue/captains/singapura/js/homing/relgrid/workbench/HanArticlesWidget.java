...
public final class HanArticlesWidget extends WorkspaceWidget<WorkspaceWidget._None, HanArticlesWidget> {
    ...
    protected List<String> constructBodyJs() {
        return List.of(
                ...
                "        var cellsB = branch.createBranch('cells-' + p.id);",
                ...
                "        var cellsB = branch.createBranch('cells-moon');",
                "        cellsB.activate(owner);",
                "        return {",
                "            id: 'moon',",
                "            fence: createHanOrnamentFence({ glyph: '\\u263E', note: '\\u5bd2\\u5c71\\u5bfa \\u00b7 \\u591c\\u534a\\u9418\\u8072' }),",
                "            grid: { branch: cellsB, relation: relation, header: { show: false }, rowView: [], columnView: relation.presentedColumns(), label: 'illustration' }",
                "        };",
                "    }",
