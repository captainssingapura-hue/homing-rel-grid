...
/** A read-only replica. Dock as many as you like; each moves on every commit, and none of their grids is told. */
public final class DishFollowerWidget extends WorkspaceWidget<WorkspaceWidget._None, DishFollowerWidget> {
    ...
    @Override public String title() { return "Dish follower"; }
    ...
    @Override
    protected List<String> constructBodyJs() { return ReplicaTable.bodyJs("follower", false); }
}
