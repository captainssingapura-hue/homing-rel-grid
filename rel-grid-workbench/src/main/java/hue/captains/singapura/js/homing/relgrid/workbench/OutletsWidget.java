...
public final class OutletsWidget extends WorkspaceWidget<WorkspaceWidget._None, OutletsWidget> {
    ...
    protected List<String> constructBodyJs() {
        return List.of(
                ...
                "        // TWO INDEPENDENT BRANCHES, both this widget's to dissolve at teardown. The",
                "        // group's OWN: its boxes and fence slots are minted on it and every member's grid",
                "        // gets a sub-branch of it. The DOMAIN's: a sub-branch per relation for its cells,",
                "        // and one per fence for what it draws. Neither side ever sees the other's.",
