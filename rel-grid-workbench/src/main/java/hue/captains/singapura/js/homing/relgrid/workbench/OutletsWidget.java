...
public final class OutletsWidget extends WorkspaceWidget<WorkspaceWidget._None, OutletsWidget> {
    ...
    protected List<String> constructBodyJs() {
        return List.of(
                ...
                "        // The group's OWN branch: its boxes and fences are minted on it, every member's",
                "        // grid gets a sub-branch of it, and teardown dissolves the lot in one move.",
                ...
                "    // owner, which is this widget, and the group's branch dissolved so the name",
                "    // is free again and nothing the group minted is left behind.",
                "    function teardown() {",
                "        var c = current;",
