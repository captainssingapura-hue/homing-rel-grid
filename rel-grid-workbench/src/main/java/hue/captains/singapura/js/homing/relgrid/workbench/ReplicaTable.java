...
final class ReplicaTable {
    ...
    static List<String> bodyJs(String role) {
        return List.of(
                ...
                "",
                "    // EXACTLY TWO BRANCHES under this widget's, and neither side ever sees the other's.",
                "    // 'grid' is handed to the grid whole, unactivated: the grid activates it and mints",
                "    // everything it makes on it. 'domain' is this widget's to divide: the relation's",
                "    // cells on 'cells' (the relation's own, which it activates), the panels the domain",
                "    // draws for the grid's questions on sessions under 'panels'. Dissolving both is",
                "    // this widget's.",
