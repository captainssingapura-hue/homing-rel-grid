 ...
 * {@link #requires()} names the grid's crate and nothing else: the group is
 * built on the table, and the table's crate requires nothing of this one.
 */
public final class RelGridGroupCrate implements Crate {
    ...
    @Override public List<Crate> requires() { return List.of(RelGridCrate.INSTANCE); }

    @Override
    public List<CrateEntry> entries() {
        return List.of(CrateEntry.of(RelGridGroupModule.INSTANCE, StandardJsModuleType.PRIMITIVE));
    }
}
